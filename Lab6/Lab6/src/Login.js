...
export const TransactionScreen = ({navigation}) => {
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name='TransactionDetail' component={TransactionDetail} options={{title: "Transaction detail", headerRight: ()=><Text style={{margin: 10}}><EntypoIcon name="dots-three-vertical" size={25} color="#fff"/></Text>}}/>
    </Stack.Navigator>
    )
}
